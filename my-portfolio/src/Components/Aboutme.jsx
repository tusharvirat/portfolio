...
const Aboutme = () => {
  ...
  return (
    <div className="bg-black flex flex-col gap-20 px-4 sm:px-8">
      ...
      <p className="text-[#676767] font-bold text-center leading-7 text-base sm:text-xl uppercase font-mono">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-8 sm:gap-20">
        <h1 className="text-[#676767] font-bold text-center text-2xl sm:text-3xl font-mono">
          LEETCODE SCORE: 12
        </h1>
        <h1 className="text-[#676767] font-bold text-2xl sm:text-3xl font-mono">
